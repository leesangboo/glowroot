...
public class PreInitializeWeavingClasses {
    ...
    private static List<String> getGlowrootUsedTypes() {
        ...
        types.add("org.glowroot.weaving.XnioMonkeyPatch");
        types.add("org.glowroot.weaving.XnioMonkeyPatch$XnioClassVisitor");
        types.add("org.glowroot.weaving.XnioMonkeyPatch$XnioClinitMethodVisitor");
        return types;
    }
    ...
    static List<String> maybeUsedTypes() {
        ...
        types.add("org.glowroot.weaving.XnioMonkeyPatch$1");
